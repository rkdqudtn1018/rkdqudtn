...
public class EvaluationDTO {
	...
	public void setProessorName(String proessorName) {
		this.professorName = proessorName;
	}
	...
	public EvaluationDTO(int evaluationID, String userID, String lectureName, String proessorName, int lectureYear,
